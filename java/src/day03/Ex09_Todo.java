	...
	public static void main(String[] args) {
		...
		switch (menuNo) {
			...
			case 3: //상태 변경
				...
				sc.nextLine();
				//상태 변경
				Status updadteStatus = statusList[statusNo-1];	//입력한 번호의 상태
				todoList[index].setStatus(updadteStatus);		//지정한 할일의 상태를 변경
				System.out.println("할일의 상태를 " + updadteStatus.getValue() + "(으/로) 변경하였습니다.");
			default:
